    ...
    <div id="header-top">
        <div class="header-top-content container">
            ...
            <ul id="login-boxes" class="list-inline">
             ...
             <li><a href="<?php echo e(URL::to('register/agent')); ?>" class="btn-success btn-agentRg"><?php echo e('Agent Registration'); ?></a></li>
             <?php endif; ?>
                    ...
                    <div class="top-menu-container col-xs-6 col-sm-8 col-md-10">
                        <nav class="main-menu-area">
                            ...
                            <li><a href="<?php echo e(URL::to('properties/')); ?>" class="<?php echo e(classActivePathPublic('properties')); ?>"><?php echo e(trans('words.all_properties')); ?></a></li>
                                ...
                                <span class="fa fa-angle-down"></span>
                                <ul class="sub-menu">
                                <li><a href="#"><?php echo e('Our Agents'); ?></a></li>
...
<?php /**PATH C:\xampp\htdocs\backupfloorfly\resources\views/_particles/header.blade.php ENDPATH**/ ?>