      ...
      <div class="widget member-card">
        <div class="member-card-header">
          <a href="Javascript::void();" class="member-card-avatar">
            ...
            <!-- <img src="<?php echo e(URL::asset(Auth::user()->profile_image)); ?>" alt="edede2222" class="profile-avatar" > -->
...
<?php endif; ?> 
    ...
    </div><?php /**PATH C:\xampp\htdocs\backupfloorfly\resources\views/_particles/sidebar_user.blade.php ENDPATH**/ ?>