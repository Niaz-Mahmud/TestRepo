            ...
            <div class="col-xs-12 col-sm-12 col-md-9">
                ...
                <div class="home-on-sale">
                    <div class="onsale-header">
                        <div class="row">
                            <div class="col-8">
                                <h2 class="home-section-title">On sale</h2>
                            </div>
                            <div class="col-4">
                                <div class="pull-right"> <a class="home-see-more"
                                        href="<?php echo e(URL::to('properties/')); ?>">See More>></a> </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="onsale-left-banner boxShadow">
                                <!-- <a href="<?php echo e($onsaleleftbanner->link); ?>"> <img
                                        src="<?php echo e(URL::asset($onsaleleftbanner->image)); ?>"
                                        alter="<?php echo e($onsaleleftbanner->name); ?>" /></a> -->
                            </div>
                        </div>
                        <!--col-md-4-->
                        ...
                        <div class="col-md-8">
                                        ...
                                        <div class="property-box boxShadow">
                                            <div class="inner-box">
                                                <a href="<?php echo e(URL::to('properties/')); ?>" class="img-container2">
                                                    ...
                                                    <img src="<?php echo e(URL::asset('upload/properties/'.$property->featured_image.'-s.jpg')); ?>"
                                                        alt="Image of Property">
                                                    <?php if($property->featured_property==1): ?>
                                                    <span class="tag-label featured-item"><i
                                                ...
                                                <div class="bottom-sec">
                                                    <a class="title"
                                                        href="<?php echo e(url('properties/'.$property->property_slug.'/'.$property->id)); ?>">
                                                        <h2><?php echo e(Str::limit($property->property_name,35)); ?></h2>
                                                    </a>
                                                    <h3 class="price"><?php echo e(getcong('currency_sign')); ?>

                                                        <span><?php echo e($property->price); ?></span></h3>
                                                    <div class="extra-info clearfix padding-bottom5">
                                                        <ul class="property-data row-list list-inline">
                                                            ...
                                                            <li class="area">
                                                               <i class="fa-columns" aria-hidden="true"></i>
                                                    ...
                                                    <span class="location-i padding-bottom5 "><i
                                                            class="fa fa-map-marker"></i>
                                                        <?php echo e(getPropertyLocationName($property->location)->name); ?></span>
                                                </div>
                            ...
                            <div class="">
                                <div class="onsale-bottom-banner boxShadow">
                                    <a href="<?php echo e($onsalebottombanner->link); ?>"> <img
                                            src="<?php echo e(URL::asset($onsalebottombanner->image)); ?>"
                                            alter="<?php echo e($onsalebottombanner->name); ?>" /></a>
                                </div>
                            </div>
                ...
                <div class="home-prem-collection">
                    <div class="prem-collection-header">
                      ...
                      ?>
                            <div class="col-8">
                                <h2 class="home-section-title">Premium Collection</h2>
                            </div>
                            <div class="col-4">
                                <div class="pull-right"> <a class="home-see-more"
                                        href="<?php echo e(URL::to('property-form-'.$i)); ?>">See More>></a> </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-xs-12 col-sm-6 col-md-6">
                                                <div class="verticale-view-left">
                                                    <a href="<?php echo e(url('properties/'.$property->property_slug.'/'.$property->id)); ?>"
                ...
                <div class="home-verified-plots">
                    <div class="verified-plots-header">
                        <div class="row">
                            ...
                            <div class="col-8">
                                <h2 class="home-section-title">Commercial Project</h2>
                            </div>
                            <div class="col-4">
                                <div class="pull-right"> <a class="home-see-more"
                                        href="<?php echo e(URL::to('type/commercial-project')); ?>">See More>></a> </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="home-verified-plots type-land">
                    <div class="verified-plots-header">
                        <div class="row">
                            ...
                            <div class="col-8">
                                <h2 class="home-section-title">Plots & Commercial Land</h2>
                            </div>
                            <div class="col-4">
                                <div class="pull-right"> <a class="home-see-more" href="<?php echo e(URL::to('type/land')); ?>">See
                                        More>></a> </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="home-Standard-Collection ">
                    <div class="verified-plots-header">
                      ...
                      ?>
                            <div class="col-8">
                                <h2 class="home-section-title">Standard Collection</h2>
                            </div>
                            <div class="col-4">
                                <div class="pull-right"> <a class="home-see-more"
                                        href="<?php echo e(URL::to('property-form-'.$i)); ?>">See More>></a> </div>
                ...
                <div class="home-Services">
                    <div class="Services-header">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="pull-right"> <a class="home-see-more"
                                        href="<?php echo e(URL::to('details/services/1')); ?>">See More>></a> </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="bottom-banner boxShadow">
                                <a href="<?php echo e($servicebanner->link); ?>"> <img src="<?php echo e(URL::asset($servicebanner->image)); ?>"
                                        alter="<?php echo e($servicebanner->name); ?>" /></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="home-Commercial">
                    <div class="Commercial-header">
                        <div class="row">
                            <div class="col-6">
                                <h2 class="home-section-title">Exclusive Product</h2>
                            </div>
                            <div class="col-6">
                                <div class="pull-right"> <a class="home-see-more"
                                        href="<?php echo e(URL::to('properties/')); ?>">See More>></a> </div>
                            ...
                            <div class="property-box boxShadow">
                                <div class="inner-box">
                                    ...
                                    <div class="bottom-sec">
                                        ...
                                        <h3 class="price"><?php echo e(getcong('currency_sign')); ?> <span><?php echo e($property->price); ?></span>
                                        </h3>
                                        <div class="extra-info clearfix padding-bottom5">
                                            <ul class="property-data row-list list-inline">
                                                <?php if($property->bedrooms!=null): ?>
                                        ...
                                        <span class="location-i padding-bottom5 "><i class="fa fa-map-marker"></i>
                                            <?php echo e(getPropertyLocationName($property->location)->name); ?></span>
                                    </div>
...
<?php echo $__env->make("app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\backupfloorfly\resources\views/pages/index.blade.php ENDPATH**/ ?>